package com.example.javadevelopementapp.rateUsActivity;
...
import com.example.javadevelopementapp.Adapters.rateUsAdapter;
...
public class rateUsRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rate_us_recyclerview);
        ...
        rateUsAdapter detailAdapters= new rateUsAdapter(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, rateUsOutput.class));
    }
