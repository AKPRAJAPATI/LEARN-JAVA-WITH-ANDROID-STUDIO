...
public class RadioButtonRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_radio_button_recyclerview);
        ...
        RadioButtonAdapters detailAdapters= new RadioButtonAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, RadioButtonOutput.class));
    }
