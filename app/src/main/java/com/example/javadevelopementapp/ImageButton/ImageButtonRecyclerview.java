...
import com.example.javadevelopementapp.Adapters.ImageButtonAdapters;
...
public class ImageButtonRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_image_button_recyclerview);
        ...
        ImageButtonAdapters detailAdapters= new ImageButtonAdapters(getApplicationContext(),arrayList);
