...
import com.example.javadevelopementapp.Adapters.chooseimageAdapter;
...
public class chooseImageRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choose_image_recyclerview);
        recyclerView = findViewById(R.id.recycleviewItems);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

         ArrayList<Model_Detail> arrayList = new ArrayList<>();
       chooseimageAdapter detailAdapters= new chooseimageAdapter(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, chooseImageOutput.class));
    }
}