...
import com.example.javadevelopementapp.Adapters.SwitchAdapters;
...
public class SwitchRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_switch_recyclerview);
        ...
        SwitchAdapters detailAdapters= new SwitchAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, SwitchOutput.class));
    }
}