...
import com.example.javadevelopementapp.Adapters.ImageSwitcherAdapters;
...
public class ImageSwitcherRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_image_switcher_recyclerview);
        ...
        ImageSwitcherAdapters detailAdapters= new ImageSwitcherAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, ImageSwitcherOutput.class));
    }
}