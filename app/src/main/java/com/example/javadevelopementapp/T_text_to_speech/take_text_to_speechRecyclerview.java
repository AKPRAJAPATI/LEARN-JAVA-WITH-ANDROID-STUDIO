package com.example.javadevelopementapp.T_text_to_speech;
...
import com.example.javadevelopementapp.Adapters.take_SpeechtoTextAdapter;
...
public class take_text_to_speechRecyclerview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        take_SpeechtoTextAdapter detailAdapters= new take_SpeechtoTextAdapter(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, ButtonOutput.class));
    }
}