...
import com.example.javadevelopementapp.Adapters.RatingBarAdapters;
...
public class RatingBarRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rating_bar_recyclerview);
        ...
        RatingBarAdapters detailAdapters= new RatingBarAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, RatingbarOutput.class));
    }
