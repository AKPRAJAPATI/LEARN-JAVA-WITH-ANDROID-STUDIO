...
import com.example.javadevelopementapp.Adapters.positionToastAdapters;
...
public class positionToastReacyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_position_toast_reacyclerview);
        ...
        positionToastAdapters detailAdapters= new positionToastAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, positionToast.class));
    }
}