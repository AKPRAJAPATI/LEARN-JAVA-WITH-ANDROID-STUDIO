...
import com.example.javadevelopementapp.Adapters.Tongle_ButtonAdapters;
...
public class TongleRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tongle_recyclerview);
        ...
        Tongle_ButtonAdapters detailAdapters= new Tongle_ButtonAdapters(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, TongleOutput.class));
    }
}