...
public class take_SpeechtoTextAdapter extends RecyclerView.Adapter<take_SpeechtoTextAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public take_SpeechtoTextAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.button_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.button_xml);
