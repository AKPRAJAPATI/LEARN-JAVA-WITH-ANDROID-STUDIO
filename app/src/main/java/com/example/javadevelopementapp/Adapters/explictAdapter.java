...
public class explictAdapter extends RecyclerView.Adapter<explictAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public explictAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.explict_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.explict_xml);
