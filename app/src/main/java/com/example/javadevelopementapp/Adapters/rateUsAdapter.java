...
public class rateUsAdapter extends RecyclerView.Adapter<rateUsAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public rateUsAdapter(Context context, ArrayList<Model_Detail> arrayList) {
