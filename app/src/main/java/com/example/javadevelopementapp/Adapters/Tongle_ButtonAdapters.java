...
public class Tongle_ButtonAdapters extends RecyclerView.Adapter<Tongle_ButtonAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public Tongle_ButtonAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.toggleJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.toggle_xml);
