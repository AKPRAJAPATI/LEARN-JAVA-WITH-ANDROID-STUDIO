...
public class RadioButtonAdapters extends RecyclerView.Adapter<RadioButtonAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public RadioButtonAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.radiojava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.radio_xml);
