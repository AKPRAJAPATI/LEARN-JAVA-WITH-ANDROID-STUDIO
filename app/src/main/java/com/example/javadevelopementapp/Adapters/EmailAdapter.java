...
public class EmailAdapter extends RecyclerView.Adapter<EmailAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public EmailAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.email_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.email_xml);
