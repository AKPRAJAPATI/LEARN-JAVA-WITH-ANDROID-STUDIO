...
public class RatingBarAdapters extends RecyclerView.Adapter<RatingBarAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public RatingBarAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.ratingbar_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.ratingbar_xml);
