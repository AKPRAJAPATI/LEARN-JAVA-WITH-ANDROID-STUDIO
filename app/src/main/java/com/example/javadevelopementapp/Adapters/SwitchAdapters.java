...
public class SwitchAdapters extends RecyclerView.Adapter<SwitchAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public SwitchAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.switchjava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.switchXml);
