...
public class whatsAppAdapter extends RecyclerView.Adapter<whatsAppAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public whatsAppAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.sendWhatsappJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.sendWhatsappxml);
