...
public class ScrollViewAdapters extends RecyclerView.Adapter<ScrollViewAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public ScrollViewAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.scroll_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.scroll_xml);
