...
public class simpleToastAdapters extends RecyclerView.Adapter<simpleToastAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public simpleToastAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.toast_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.Toast_xml);
