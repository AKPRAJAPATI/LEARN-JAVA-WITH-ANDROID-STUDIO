...
public class implictAdapter extends RecyclerView.Adapter<implictAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public implictAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.implictjava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.implictxml);
