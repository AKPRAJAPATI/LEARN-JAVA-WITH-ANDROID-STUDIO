...
public class PopupMenuAdapter extends RecyclerView.Adapter<PopupMenuAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public PopupMenuAdapter(Context context, ArrayList<Model_Detail> arrayList) {
