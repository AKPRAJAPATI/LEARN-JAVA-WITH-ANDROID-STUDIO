...
public class chooseimageAdapter extends RecyclerView.Adapter<chooseimageAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public chooseimageAdapter(Context context, ArrayList<Model_Detail> arrayList) {
