...
public class ContentMenuAdapter extends RecyclerView.Adapter<ContentMenuAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public ContentMenuAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.contentMenuJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.contentMenuXml);
