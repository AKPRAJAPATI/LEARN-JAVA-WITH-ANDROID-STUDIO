...
public class CheckBoxAdapters extends RecyclerView.Adapter<CheckBoxAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public CheckBoxAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.check_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.check_xml);
