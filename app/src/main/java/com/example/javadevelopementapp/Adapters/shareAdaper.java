...
public class shareAdaper extends RecyclerView.Adapter<shareAdaper.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public shareAdaper(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.shareJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.shareXml);
