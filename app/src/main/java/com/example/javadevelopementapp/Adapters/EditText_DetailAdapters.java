...
public class EditText_DetailAdapters extends RecyclerView.Adapter<EditText_DetailAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public EditText_DetailAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.java_editText);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.editTExtXml);
