...
public class ImageSwitcherAdapters extends RecyclerView.Adapter<ImageSwitcherAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public ImageSwitcherAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.imageSwitcher_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.imageSwitcher_xml);
