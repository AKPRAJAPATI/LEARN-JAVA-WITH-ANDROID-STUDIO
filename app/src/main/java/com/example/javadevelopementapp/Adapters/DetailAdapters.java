...
public class DetailAdapters extends RecyclerView.Adapter<DetailAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public DetailAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.firstprogram);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.FirstprogramMainXml);
