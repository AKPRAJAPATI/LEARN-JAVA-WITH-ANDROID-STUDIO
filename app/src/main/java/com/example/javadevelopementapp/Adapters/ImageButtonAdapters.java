...
public class ImageButtonAdapters extends RecyclerView.Adapter<ImageButtonAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public ImageButtonAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.imageBtnjava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.imageBtnxml);
