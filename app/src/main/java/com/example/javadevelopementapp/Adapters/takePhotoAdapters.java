...
public class takePhotoAdapters extends RecyclerView.Adapter<takePhotoAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public takePhotoAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.takePhotoJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.takePhotoxml);
