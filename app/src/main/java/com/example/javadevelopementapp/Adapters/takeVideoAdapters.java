...
public class takeVideoAdapters extends RecyclerView.Adapter<takeVideoAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public takeVideoAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.videoViewJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.videoViewXml);
