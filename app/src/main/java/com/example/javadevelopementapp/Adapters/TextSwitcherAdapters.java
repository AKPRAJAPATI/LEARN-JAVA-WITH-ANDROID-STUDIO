...
public class TextSwitcherAdapters extends RecyclerView.Adapter<TextSwitcherAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public TextSwitcherAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.textSwitcher_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.textSwitcher_xml);
