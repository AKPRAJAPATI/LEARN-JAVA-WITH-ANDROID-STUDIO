...
public class OptionMenuAdapter extends RecyclerView.Adapter<OptionMenuAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public OptionMenuAdapter(Context context, ArrayList<Model_Detail> arrayList) {
