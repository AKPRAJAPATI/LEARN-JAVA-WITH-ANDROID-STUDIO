...
public class positionToastAdapters extends RecyclerView.Adapter<positionToastAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public positionToastAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.positionToast_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.positionToast_xml);
