...
public class coloredToastAdapters extends RecyclerView.Adapter<coloredToastAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public coloredToastAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.colorToast_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.colorToast_xml);
