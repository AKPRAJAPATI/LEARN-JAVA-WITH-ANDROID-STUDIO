...
public class SeekBarAdapters extends RecyclerView.Adapter<SeekBarAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public SeekBarAdapters(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.seekbar_java);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.seekbarxml);
