...
public class copyAdapter extends RecyclerView.Adapter<copyAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public copyAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.copytextJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.copytextxml);
