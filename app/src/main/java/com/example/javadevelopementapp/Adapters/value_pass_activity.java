...
public class value_pass_activity extends RecyclerView.Adapter<value_pass_activity.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public value_pass_activity(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.valuePassJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.valuePassXml);
