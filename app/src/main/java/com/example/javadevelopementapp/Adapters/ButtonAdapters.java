...
public class ButtonAdapters extends RecyclerView.Adapter<ButtonAdapters.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public ButtonAdapters(Context context, ArrayList<Model_Detail> arrayList) {
