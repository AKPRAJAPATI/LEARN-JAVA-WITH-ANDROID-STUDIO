...
public class text_To_speechAdapter extends RecyclerView.Adapter<text_To_speechAdapter.DetailViewHolder> {
    Context context;
    ArrayList<Model_Detail> arrayList;

    public text_To_speechAdapter(Context context, ArrayList<Model_Detail> arrayList) {
            ...
            public void onClick(View view) {
                switch (myItemPosition) {
                    ...
                    case 1:
                        ...
                        intent.putExtra("codingMain", Code.textToSpeechJava);
                    ...
                    case 2:
                        ...
                        intent3.putExtra("codingXml",Code.textToSpeechXml);
