...
import com.example.javadevelopementapp.Adapters.ContentMenuAdapter;
...
public class contentMenuRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content_menu_recyclerview);
        ...
        ContentMenuAdapter detailAdapters= new ContentMenuAdapter(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, ContentMenuOutput.class));
    }
}