...
import com.example.javadevelopementapp.Adapters.explictAdapter;
...
public class ExplictRecyclerview extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_explict_recyclerview);
        ...
        explictAdapter detailAdapters= new explictAdapter(getApplicationContext(),arrayList);
    ...
    public void outPutActivity(View view) {
        startActivity(new Intent(this, ExplictOutput.class));
    }
}